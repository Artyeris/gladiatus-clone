...
export const expeditions: Expeditions = {
  ...
  voodootemple: {
    ...
    id: 'voodootemple',
    country: 'africa',
    description: 'A jungle clearing thick with chanting, drums and old gods. The voodoo priests welcome strangers exactly the wrong way.',
    entryLevel: 20,
    enemyLevels: '28-38',
    realLevel: '24',
  },
  bridge: {
    ...
    id: 'bridge',
    country: 'africa',
    description: 'A rope bridge over a deep gorge. Tribal warriors hold both ends and demand toll in blood.',
    entryLevel: 25,
    enemyLevels: '33-43',
    realLevel: '29',
  },
  bloodcave: {
    ...
    id: 'bloodcave',
    country: 'africa',
    description: 'A coppery stench seeps from a crack in the cliffs. Inside, ritual circles glisten and venomous things scuttle.',
    entryLevel: 30,
    enemyLevels: '38-48',
    realLevel: '34',
  },
  lostharbour: {
    ...
    id: 'lostharbour',
    country: 'africa',
    description: 'An abandoned trading port turned smuggler nest. Rotten piers, salt-bleached crates and very nervous guards.',
    entryLevel: 35,
    enemyLevels: '43-53',
    realLevel: '39',
  },
  ...
  caravan: {
    ...
    id: 'caravan',
    country: 'africa',
    description: 'A heavily-guarded merchant caravan crawling through the dunes. Heavy purses make heavy targets.',
    entryLevel: 80,
    enemyLevels: '88-98',
    realLevel: '84',
  },
  mesoaoasis: {
    ...
    id: 'mesoaoasis',
    country: 'africa',
    description: 'Palms, mirrored water, and the kind of predators that learnt to wait at the only waterhole for a hundred miles.',
    entryLevel: 85,
    enemyLevels: '93-103',
    realLevel: '89',
  },
  cliffjumper: {
    ...
    id: 'cliffjumper',
    country: 'africa',
    description: 'A vertical cliff that locals leap from to prove their worth. The beasts at the bottom thank them.',
    entryLevel: 90,
    enemyLevels: '98-108',
    realLevel: '94',
  },
  ...
  cavetemple: {
    ...
    id: 'cavetemple',
    country: 'germania',
    description: 'A pitch-black shrine cut into the rock. Cultists chant for things best left undisturbed.',
    entryLevel: 40,
    enemyLevels: '48-58',
    realLevel: '44',
  },
  greenforest: {
    ...
    id: 'greenforest',
    country: 'germania',
    description: 'Old growth so dense the canopy never lets the sun reach the floor. Things in the dark have very long teeth.',
    entryLevel: 45,
    enemyLevels: '53-63',
    realLevel: '49',
  },
  cursedvillage: {
    ...
    id: 'cursedvillage',
    country: 'germania',
    description: 'A settlement that should not still be inhabited. The villagers still are, just not in the way you want.',
    entryLevel: 50,
    enemyLevels: '58-68',
    realLevel: '54',
  },
  deathhill: {
    ...
    id: 'deathhill',
    country: 'germania',
    description: 'Centuries of graves piled high. Whatever was buried up here is not staying buried.',
    entryLevel: 55,
    enemyLevels: '63-73',
    realLevel: '59',
  },
  vandalvillage: {
    ...
    id: 'vandalvillage',
    country: 'germania',
    description: 'Hardened raiders who returned home with Roman scars and worse manners.',
    entryLevel: 95,
    enemyLevels: '103-113',
    realLevel: '99',
  },
  mine: {
    ...
    id: 'mine',
    country: 'germania',
    description: 'A working ore mine. Lots of treasure, lots of overseers, lots of teeth.',
    entryLevel: 100,
    enemyLevels: '108-118',
    realLevel: '104',
  },
  teutoncamp: {
    ...
    id: 'teutoncamp',
    country: 'germania',
    description: 'A barbarian war-camp. Drums, fires and very large axes.',
    entryLevel: 104,
    enemyLevels: '112-122',
    realLevel: '108',
  },
  komanmountain: {
    ...
    id: 'komanmountain',
    country: 'germania',
    description: 'Towering peak that hosts the meanest natural predators in Germania.',
    entryLevel: 108,
    enemyLevels: '116-126',
    realLevel: '112',
  },
  dragonremains: {
    ...
    id: 'dragonremains',
    country: 'germania',
    description: 'The bones are bigger than your house and something still scavenges through them.',
    entryLevel: 112,
    enemyLevels: '120-130',
    realLevel: '116',
  },
  ...
  bankofthames: {
    ...
    id: 'bankofthames',
    country: 'britannia',
    description: 'A muddy invasion beachhead. The locals would rather you stayed on your boats.',
    entryLevel: 120,
    enemyLevels: '128-138',
    realLevel: '124',
  },
  forestfortress: {
    ...
    id: 'forestfortress',
    country: 'britannia',
    description: 'A wooden stronghold buried under canopy. Hard to find, harder to leave.',
    entryLevel: 130,
    enemyLevels: '138-148',
    realLevel: '134',
  },
  themoor: {
    ...
    id: 'themoor',
    country: 'britannia',
    description: 'Fog so thick you can chew it. Mire that swallows horses. Things that hunt by sound.',
    entryLevel: 140,
    enemyLevels: '148-158',
    realLevel: '144',
  },
  campcassivellaunus: {
    ...
    country: 'britannia',
    description: 'A Briton warlord\'s field camp. Disciplined, fortified, lethal.',
    entryLevel: 150,
    enemyLevels: '158-168',
    realLevel: '154',
  },
  kent: {
    ...
    id: 'kent',
    country: 'britannia',
    description: 'Countryside long ago turned to a war region. Every barn hides another ambush.',
    entryLevel: 160,
    enemyLevels: '168-178',
    realLevel: '164',
  },
  theford: {
    ...
    id: 'theford',
    country: 'britannia',
    description: 'A river crossing the Britons know far better than your scouts do.',
    entryLevel: 170,
    enemyLevels: '178-188',
    realLevel: '174',
  },
  camulodunum: {
    ...
    id: 'camulodunum',
    country: 'britannia',
    description: 'Smouldering ruins of a once-Roman city. Elite defenders pick over what is left.',
    entryLevel: 180,
    enemyLevels: '188-198',
    realLevel: '184',
  },
  cambria: {
    ...
    id: 'cambria',
    country: 'britannia',
    description: 'Highland wilderness with bigger predators than reason permits.',
    entryLevel: 190,
    enemyLevels: '198-208',
    realLevel: '194',
  },
  monaisle: {
    ...
    id: 'monaisle',
    country: 'britannia',
    description: 'The druids\' final stronghold. A ritual island where every step is contested.',
    entryLevel: 200,
    enemyLevels: '208-220',
    realLevel: '204',
  },
